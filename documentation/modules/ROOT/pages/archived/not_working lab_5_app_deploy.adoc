...
image:app-overview.png[Application diagram,width=100%]
...
image:app-overview-1.png[Application]

image:app-overview-2.png[Application]

image:app-overview-3.png[Application]
...
image:mongodb-overview.png[MongoDB deployment]
...
image:mongo-svc-webconsole.png[MongoDB service in the Web Console]
...
image:rating-web-homepage.png[rating-web homepage]
...
image:rating-web-github-secret.png[Rating Web GitHub trigger secret]
...
. Click *Add webhook*.
+
image:gitea-webhook.png[Gitea add webhook]
...
----
+
image:create-networkpolicy.png[Create network policy]
